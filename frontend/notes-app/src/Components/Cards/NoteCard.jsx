...
const NoteCard = ({
  ...
  return (
    <div onClick={onTapped} className="h-full cursor-pointer">
      <div className="flex h-full min-h-50 flex-col justify-between rounded border border-neutral-600 bg-[#1C2541] p-4 shadow-md transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl dark:border-dark dark:bg-[#1E293B] dark:shadow-gray-600/20">
        <div>
