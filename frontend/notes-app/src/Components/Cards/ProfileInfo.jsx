  ...
  return (
    ...
    >
      ...
      <div
        ...
        onMouseLeave={scheduleClose}
        className={`absolute -right-5 top-full mt-2 z-50 w-43 rounded border border-gray-200 p-4 shadow-lg transition-all duration-500 ease-in-out dark:border-gray-700 bg-slate-900 ${
          isOpen
